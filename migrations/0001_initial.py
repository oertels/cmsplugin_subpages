...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_subpage', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('amount_pages', self.gf('django.db.models.fields.PositiveIntegerField')(default=10)),
            ('template', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('cmsplugin_subpages', ['SubPage'])


    def backwards(self, orm):
        # Deleting model 'SubPage'
        db.delete_table('cmsplugin_subpage')
